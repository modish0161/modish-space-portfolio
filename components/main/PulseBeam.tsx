...
export const PulseBeam = () => {
  return (
    <div className="flex h-[40rem] relative items-center justify-center antialiased overflow-hidden">
      {/* Adjust the opacity of the container background */}
      <div className="absolute inset-0 bg-slate-950 opacity-50"></div>
      
      {/* The content of your pulse beam component */}
      <div className="relative">
        <button className="w-[320px] z-40 h-[120px] no-underline group cursor-pointer relative rounded-full p-px text-xs font-semibold leading-6 text-white inline-block" style={{ backgroundColor: "rgba(31, 41, 55, 0)", boxShadow: "0 4px 6px rgba(0, 0, 0, 0), 0 1px 3px rgba(0, 0, 0, 0)" }}>
