...
export function ThreeDCardDemo() {
  ...
  const projects = [
    ...
    { 
      ...
      tryNowRoute: "/About-Slides-Project2",
    ...
    { 
      ...
      tryNowRoute: "/About-Slides-Project3",
    ...
    { 
      ...
      description: "Creating secure Smart Contracts with expert Solidity on the blockchain.", 
