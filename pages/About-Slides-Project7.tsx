...
export default function Home() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: `By streamlining complex trade processes and automating compliance and verification, smart contracts on Zero-Blockchain.xyz significantly reduce the time and cost associated with global trade. Our platform is set to redefining international commerce.`,
      image: "/images/Smarts Contracts & Solidity Programmming/9.webp"
    },
    {
      title: "PIONEERING IN PRIVACY AND DATA PROTECTION",
      description: `In an era where data privacy is paramount, Zero-Blockchain.xyz is pioneering the integration of advanced cryptographic techniques, such as Zero-Knowledge Proofs, into smart contracts. This approach ensures that sensitive information is secure.`,
      image: "/images/Smarts Contracts & Solidity Programmming/10.webp"
    },
    {
      title: "BUILDING A SUSTAINABLE BLOCKCHAIN ECOSYSTEM",
      description: `Our approach goes beyond transactions; it's about building a sustainable, eco-friendly blockchain ecosystem. Smart contracts are key in automating and verifying compliance with environmental standards and sustainability goals.`,
      image: "/images/Smarts Contracts & Solidity Programmming/11.webp"
    },
    {
      title: "DRIVING INNOVATION THROUGH EDUCATION",
      description: `Zero-Blockchain.xyz is committed to driving blockchain innovation through education. By demystifying smart contracts and blockchain technology, we empower developers, businesses, and enthusiasts to contribute to the blockchain ecosystem.`,
    ...
    {
      title: "EDUCATION",
      description: `Revolutionizing education through verifiable digital credentials and secure academic record-keeping, smart contracts foster trust and accessibility across educational institutions
      helping tomorrows children within our society.`,
        ...
        <section className="relative w-full overflow-hidden bg-gray-100 py-12 md:py-24 xl:py-32 dark:bg-gray-850">
          <div className="container px-4 space-y-12 md:space-y-16 xl:space-y-20 dark:text-gray-250 text-center mx-auto">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-16 text-justify">
              ...
              <p className="text-sm leading-relaxed md:text-base lg:text-lg">
                Join us in exploring the boundless opportunities provided by blockchain technology. Discover how Zero-Blockchain.xyz can transform your financial experience through our innovative services, educational programs, and pioneering projects. Embark with us on a journey to redefine digital finance, making it more accessible, secure, and efficient for all.
              </p>
            </div>
          </div>
        </section>
        <h2 className="text-lg font-bold tracking-tighter sm:text-lg md:text-xl lg:text-xl mx-auto text-white mb-0">Slides & Use Cases for Industry</h2>
        {/* 3D Cards Section */}
